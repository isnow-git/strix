...
/**
 * Whether an entry is a separator/placeholder rather than a real channel: playlists
 * often inject group headers like "### SPORT ###" or entries with no stream. These
 * must never appear in the channel list.
 */
