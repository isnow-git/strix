 ...
 *
 * On low-RAM TVs the default image-loader cache (a fixed share of the heap) can still
 * be too aggressive, so we take a conservative fraction and clamp it, trading a few
